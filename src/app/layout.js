...
const APP_NAME = "Streamable";
const APP_DEFAULT_TITLE = "Streamable - Watch Anime Online";
const APP_DESCRIPTION = "Explore a vast collection of anime on Streamable, your go-to destination for streaming the latest and classic anime series. Immerse yourself in captivating storylines, vibrant animation, and diverse genres. Discover a world of entertainment at your fingertips with Streamable, where every episode is an adventure.";

export const metadata = {
  metadataBase: new URL('https://Streamablenow.live'),
