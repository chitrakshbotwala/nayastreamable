    ...
    <div>
      ...
      <div className="mx-auto w-[94%] lg:w-[80%]">
        ...
        <p className="mt-4 text-[#bdbdbd]">
          Streamablenow.live is committed to respecting the intellectual property
        ...
        <p className="mt-4 text-[#bdbdbd]">
          None of the files listed on Streamablenow.live are hosted on our servers. All
          ...
          to{" "}
          <Link href="mailto:contact@Streamablenow.live" className="text-white">
            contact@Streamablenow.live
          </Link>{" "}
